...
public class Problem7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_yes = findViewById(R.id.seven_btn_yes);
        btn_no = findViewById(R.id.seven_btn_no);
        seven_1 =findViewById(R.id.seven_1);
        ...
        if(Global.real7){
            ...
            seven_2.setVisibility(View.VISIBLE);
        }
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        if(what.equals("")){
                            ...
                            databaseReference.child("result").push().setValue("안건7"+"/"+what);
                          Global.real7 = true;
                            finish();
                        }
