...
public class ProblemOneActivity extends AppCompatActivity {
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edt_answer.getText().toString().equals("")) {
                    Toast.makeText(ProblemOneActivity.this, "정답을 입력해주세요!", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if(answer.equals(correct[0])) {
                        if(Global.firstProblem[0] == 1) {
                            Toast.makeText(ProblemOneActivity.this, "이미 푼 문제입니다!", Toast.LENGTH_SHORT).show();
                        }else {
                            totalScore += 1;
                            isOneSolved = true;
                        ...
                        Toast.makeText(ProblemOneActivity.this, "정답이 아닙니다! 다시 한번 생각해보세요", Toast.LENGTH_SHORT).show();
                    }
