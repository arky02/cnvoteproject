        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edt_answer.getText().toString().equals("")) {
                    Toast.makeText(Problem4Activity.this, "정답을 입력해주세요!", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if(answer.equals(correct[0])) {
                        if(Global.fourthProblem[0] == 1) {
                            Toast.makeText(Problem4Activity.this, "이미 푼 문제입니다!", Toast.LENGTH_SHORT).show();
                        }else {
                            totalScore += 4;
                            isOneSolved = true;
                        ...
                        Toast.makeText(Problem4Activity.this, "정답이 아닙니다! 다시 한번 생각해보세요", Toast.LENGTH_SHORT).show();
                    }
